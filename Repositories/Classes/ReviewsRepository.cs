...
namespace LibraryAPI.Repositories {
    public class ReviewsRepository : IReviewsRepository {
        ...
        public IEnumerable<ReviewDTO> GetAllBookReviews () {
            var reviews = (from r in _db.Reviews join b in _db.Books on r.BookId equals b.Id where b.Deleted == false select new ReviewDTO {
                UserId = r.UserId,
                    BookTitle = b.Title,
                    BookId = r.BookId,
        ...
        public IEnumerable<ReviewDTO> GetAllReviewsForBook (int bookId) {
            ...
            var reviews = (from r in _db.Reviews join b in _db.Books on r.BookId equals b.Id where b.Id == bookId &&
                b.Deleted == false select new ReviewDTO {
                    UserId = r.UserId,
                        BookTitle = b.Title,
                        BookId = r.BookId,
                        ReviewText = r.ReviewText,
        ...
        public IEnumerable<ReviewDTO> GetReviewsForUser (int userId) {
            ...
            return (from r in _db.Reviews where r.UserId == userId join b in _db.Books on r.BookId equals b.Id where b.Deleted == false select new ReviewDTO {
                UserId = userId,
                    BookTitle = b.Title,
                    BookId = r.BookId,
                    ReviewText = r.ReviewText,
        ...
        public ReviewDTO GetBookReviewFromUser (int userId, int bookId) {
            ...
            if (review == null) {
                throw new NotFoundException ("Review for book with id " + bookId + " and user with id " + userId + " not found.");
            }
            return new ReviewDTO {
