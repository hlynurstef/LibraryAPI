...
namespace LibraryAPI.Repositories {
    public class BooksRepository : IBooksRepository {
        ...
        public IEnumerable<BookDTOLite> GetBooks () {
            var books = (from b in _db.Books where b.Deleted == false select new BookDTOLite {
                Id = b.Id,
                    Title = b.Title,
                    Author = b.Author,
                    ...
                    Reviews = (from r in _db.Reviews where r.BookId == b.Id select new ReviewDTO {
                        BookId = r.BookId,
                            UserId = r.UserId,
                            BookTitle = b.Title,
        ...
        public BookDTOLite AddBook (BookView book) {
            var bookCheck = (from b in _db.Books where b.ISBN == book.ISBN &&
            ...
            return new BookDTOLite {
                Id = bookEntity.Id,
                    ...
                    ISBN = book.ISBN,
                    Available = true,
                    Reviews = (from r in _db.Reviews where r.BookId == bookEntity.Id select new ReviewDTO {
                        BookId = r.BookId,
                        UserId = r.UserId,
        ...
        public BookDTO GetBookById (int id) {
            var book = (from b in _db.Books where b.Id == id &&
                b.Deleted == false select new BookDTO {
                    Id = b.Id,
                        Title = b.Title,
                        Author = b.Author,
                        ReleaseDate = b.ReleaseDate,
                        ...
                        LoanHistory = (from l in _db.Loans where l.BookId == b.Id select new LoanDTO {
                            BookTitle = b.Title,
                                Id = l.Id,
                                LoanDate = l.LoanDate,
                                EndDate = l.EndDate
        ...
        public IEnumerable<BookDTOLite> GetBooksByUserId (int userId) {
            ...
            var books = (from b in _db.Books join l in _db.Loans on b.Id equals l.BookId where b.Deleted == false &&
                l.UserId == userId &&
                l.HasBeenReturned == false select new BookDTOLite {
                    Id = b.Id,
                        Title = b.Title,
                        Author = b.Author,
                        ReleaseDate = b.ReleaseDate,
        ...
        public void ReturnBook (int userId, int bookId) {
            ...
            Loan loan = (from l in _db.Loans where l.UserId == userId &&
                l.BookId == bookId &&
                l.HasBeenReturned == false join b in _db.Books on l.BookId equals b.Id select l).FirstOrDefault ();
        ...
        public IEnumerable<BookDTOLite> GetBooksOnLoan (DateTime queryDate) {
            var books = (from b in _db.Books join l in _db.Loans on b.Id equals l.BookId where queryDate >= l.LoanDate &&
                (queryDate < l.EndDate || l.EndDate == null) select new BookDTOLite {
                    Id = b.Id,
                        Title = b.Title,
                        Author = b.Author,
                        ReleaseDate = b.ReleaseDate,
